...
class EndPoint {
  ...
  static String get aboutUsURL => '$BASE_URL/api/v1/pages/all-pages';
  //static String get termsConditionURL => '$BASE_URL/api/v1/pages/all-pages';
 // static String get privacyPolicyURL => '$BASE_URL/api/v1/pages/all-pages';
