...
class MatchLivePremierLeague extends StatelessWidget {
  const MatchLivePremierLeague({super.key});
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => controller.togglePremierLeague(),
                    child: Obx(() => Container(
                      height: 32,
                      width: 32,
                      decoration: const BoxDecoration(
                      ...
                      child: Icon(
                        controller.isPremierLeagueExpanded.value
            ...
            // Matches section
            Obx(() {
              if (!controller.isPremierLeagueExpanded.value) {
